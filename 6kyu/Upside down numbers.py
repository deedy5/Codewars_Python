...
To clarify, if we write them down on a paper and turn the paper upside down, the numbers will be the same. Try it and see! 
...
def solve(a, b):
    tr = str.maketrans('2345679', 'XXXX9X6')
    return sum(f"{n}" == f"{n}"[::-1].translate(tr) for n in range(a,b))
